registerLayout("Dual LPG", {
  ...
  "boardId": "n8synth-10hp",
  "revision": "0.26-photo-recon",
  ...
  "jumpers": [
    ...
    {
      "id": "JW_R6_LED_A",
      "label": "LED_DRIVE_A -> spare 11R (above board)",
      "r1": 8,
      "c1": "b",
      "r2": 11,
      "c2": "ctrlRo",
    ...
    {
      "id": "JW_R32_MAN_A",
      "label": "spare 15R -> MANUAL A wiper (under board)",
      "r1": 15,
      "c1": "ctrlRi",
      "r2": 5,
      "c2": "ctrlLi",
    ...
    {
      "id": "JW_R17_IN",
      "label": "12R -> CH A STRIKE (under board)",
      "r1": 12,
      "c1": "ctrlRo",
      "r2": 20,
      "c2": "ctrlRi",
    ...
    {
      "id": "JW_R16_IN",
      "label": "CV_PROT_A 10R -> spare 14R (above board)",
      "r1": 10,
      "c1": "j",
      "r2": 14,
      "c2": "ctrlRo",
    ...
    {
      "id": "JW_R25_STRB",
      "label": "26R -> CH B STRIKE (under board)",
      "r1": 26,
      "c1": "ctrlRo",
      "r2": 35,
      "c2": "ctrlLi",
  ...
  "powerWires": [
    ...
    },
    {
      ...
      "r2": 27,
      "c2": "pwrL",
      "label": "local GND \u2014 row 26 left (zener / local returns, ch B)",
      "stage": 3
    }
  ],
  "jpsWires": [
