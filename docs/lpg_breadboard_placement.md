...
<!-- GEN:MAPS:START — auto-generated by tools/visualizer/gen_rowmap.py from lpg.json rev 0.25-photo-recon. Do not hand-edit between these markers; re-run the generator. -->

### Breadboard row map (cols a–j) — rev 0.25-photo-recon
...
### Control-board map (ctrlL / ctrlR) — rev 0.25-photo-recon
...
| 14 | R_STATUS_B.2@ctrlLi (4K7), _JW_STATB_ | — |
