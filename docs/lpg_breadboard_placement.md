...
<!-- GEN:MAPS:START — auto-generated by tools/visualizer/gen_rowmap.py from lpg.json rev 0.22. Do not hand-edit between these markers; re-run the generator. -->

### Breadboard row map (cols a–j) — rev 0.22
...
| 7 | `LED_DRIVE_A` | R6.2@b (470R), VD5.1@c (Zener 6v8), **VC_A_L.3**@d | `GND` | **VC_A_R.2**@g |
...
### Control-board map (ctrlL / ctrlR) — rev 0.22
