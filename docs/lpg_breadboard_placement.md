...
<!-- GEN:MAPS:START — auto-generated by tools/visualizer/gen_rowmap.py from lpg.json rev 0.19. Do not hand-edit between these markers; re-run the generator. -->

### Breadboard row map (cols a–j) — rev 0.19
...
| 5 | `V_p_A` | R5.1@a (10K), R3.1@b (4M7), C13.1@c (1nF), **VC_A_L.1**@d | `VC_A_LDR1_IN` | **VC_A_R.4**@g, R4.2@h (10K) |
| 6 | `LED_CHAIN_MID_A` | **VC_A_L.2**@d, _JW_VCA_MID_ | `LED_CHAIN_MID_A` | _JW_VCA_MID_, **VC_A_R.3**@g |
| 7 | `LED_DRIVE_A` | R6.2@b (470R), VD5.1@c (Zener 6v8 (socketed; A/B 3v9 / 6v8 / 9v1)), **VC_A_L.3**@d | `GND` | **VC_A_R.2**@g |
| 8 | `V_x_A` | C11.1@b (220pF), **VC_A_L.4**@d, _JW_VCA_VX_ | `V_x_A` | _JW_VCA_VX_, **VC_A_R.1**@g |
| 10 | `C15_a` | R17.2@a (1K), C15.1@b (1uF) | `CV_PROT_A` | R13.1@h (100K), _JW_P1cA_, R16.2@j (1K) |
| 11 | `C15_b` | C15.2@a (1uF), R15.1@b (10K), VD1.1@c (1N4148) | `—` | — |
| 12 | `STRIKE_PULSE_A` | VD1.2@c (1N4148), R34.1@d (10K) | `—` | — |
...
| 25 | `LED_DRIVE_B` | R12.2@b (470R), VD6.1@c (Zener 6v8 (socketed; A/B 3v9 / 6v8 / 9v1)), **VC_B_L.3**@d | `GND` | **VC_B_R.2**@g |
...
### Control-board map (ctrlL / ctrlR) — rev 0.19

| Row | Left CTRL (ctrlL) | Right CTRL (ctrlR) |
|-----|-------------------|--------------------|
| 1 | OUTA, R_OUT_A.2@ctrlL (1K) | INA, _JW_INA_ |
| 4 | P2a ⏚ | P3a ↔b |
| 5 | P2b, R32.1@ctrlL (4K7) | P3b, R6.1@ctrlR (470R) |
| 6 | P2c, R29.1@ctrlL (4K7) | P3c, _JW_P3cA_ |
| 7 | LAa ⏚ | P1a ⏚ |
| 8 | LAb, R_STATUS_A.2@ctrlL (4K7) | P1b, R38.1@ctrlR (4K7) |
| 9 | — | P1c, _JW_P1cA_ |
| 17 | MIX, _JW_MIX_ | CVA, R16.1@ctrlR (1K) |
| 20 | P7a ↔b | R17.1@ctrlR (1K), STA |
| 21 | P7b, R12.1@ctrlL (470R) | — |
| 22 | P7c, _JW_P7cB_ | — |
| 23 | OUTB, R_OUT_B.2@ctrlL (1K) | INB, _JW_INB_ |
| 32 | LBa ⏚ | P5a ⏚ |
| 33 | LBb, R_STATUS_B.2@ctrlL (4K7) | P5b, R39.1@ctrlR (4K7) |
| 34 | — | P5c, _JW_P5cB_ |
| 35 | R25.1@ctrlL (1K), STB | P6a ⏚ |
| 36 | — | P6b, R33.1@ctrlR (4K7) |
| 37 | — | P6c, R30.1@ctrlR (4K7) |
| 38 | — | CVB, R22.1@ctrlR (1K) |
