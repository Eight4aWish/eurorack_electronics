...
<!-- GEN:MAPS:START — auto-generated by tools/visualizer/gen_rowmap.py from lpg.json rev 0.21. Do not hand-edit between these markers; re-run the generator. -->

### Breadboard row map (cols a–j) — rev 0.21
...
### Control-board map (ctrlL / ctrlR) — rev 0.21
